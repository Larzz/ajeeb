...
@section('content')
                            ...
                            <div class="panel-body">
                                <div class="row">
                                                ...
                                                <div class="card">
                                                    <div class="card-body">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" class="form-control" id="name" aria-describedby="emailHelp" placeholder="e.g Vinegar">
                                                                <small id="emailHelp" class="form-text text-muted">We'll never share your email with anyone else.</small>
                                                            </div>
                                                            <div class="form-group">
                                                                <label for="exampleInputPassword1">Description</label>
                                                                <textarea name="" class="form-control" id="description" cols="5" rows="6"></textarea>
                                                            </div>                                          
                                                    </div>
                                                </div>
                                        </div>
                                            ...
                                            <div class="card">
                                                <div class="card-body">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" class="form-control" id="name_ar" aria-describedby="emailHelp" placeholder="e.g Vinegar">
                                                            <small id="emailHelp" class="form-text text-muted">We'll never share your email with anyone else.</small>
                                                        </div>
                                                        <div class="form-group">
                                                            <label for="exampleInputPassword1">Arabic Description</label>
                                                            <textarea name="" class="form-control" id="description_ar" cols="5" rows="6"></textarea>
                                                        </div>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-md-12" id="image_section" style="display: none">
                                        ...
                                        <div class="form-group">
                                            <button type="submit" id="back" class="btn btn-primary pull-right">Done</button>
                                        </div>
                                    </div> 
    ...
    <input type="hidden" class="product_id" id="product_id" value="11">
   ...
   $('#fine-uploader-gallery').fineUploader({
    ...
    $('#submit').click(function() {
        ...
        $.ajax({
            type: "POST",
            dataType: "json",
            url: `{{ route('administrator.store_products') }}`,
            data: data,
            headers: {
                "X-CSRF-TOKEN": $('meta[name="csrf-token"]').attr("content"),
            },
